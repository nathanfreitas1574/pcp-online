...
import {
  ...
  Ship, Crosshair, ShieldAlert, PieChart, Receipt, History, GitCompareArrows, Boxes, ShieldQuestion, Droplets, Brush, FileX2, Gauge, ClipboardCheck, Factory, Scale, Repeat, TrendingDown,
} from "lucide-react"
...
const nav: NavItem[] = [
  ...
  { section: "Recebimento" },
  { href: "/recebimento-controle", label: "Controle de Recebimento", icon: Download },
  ...
  { href: "/indicadores-perda", label: "KPI PCP", icon: Gauge },
  { href: "/financeiro", label: "Financeiro", icon: DollarSign },
  { href: "/custos", label: "Custo/Tonelada", icon: Receipt },
  { section: "Operação" },
  { href: "/vira", label: "Programação do Vira", icon: Repeat },
